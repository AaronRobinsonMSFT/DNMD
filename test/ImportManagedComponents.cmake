...
if (WIN32)
    set_target_properties(Regression.Locator PROPERTIES
        IMPORTED_LOCATION ${CMAKE_BINARY_DIR}/managed/bin/Regression.Locator/debug/Regression.LocatorNE.dll
        ...
        IMPORTED_IMPLIB ${CMAKE_BINARY_DIR}/managed/bin/Regression.Locator/debug/Regression.LocatorNE.lib
...
elseif (APPLE)
    set_target_properties(Regression.Locator PROPERTIES
        IMPORTED_LOCATION ${CMAKE_BINARY_DIR}/managed/bin/Regression.Locator/debug/Regression.LocatorNE.dylib
    ...
    set_target_properties(Regression.Locator PROPERTIES
        IMPORTED_LOCATION ${CMAKE_BINARY_DIR}/managed/bin/Regression.Locator/debug/Regression.LocatorNE.so
